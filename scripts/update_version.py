...
def main():
  ...
  plistpath = scriptpath + "/resources/DelaySum-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DelaySum-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DelaySum-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DelaySum-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/DelaySum-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/DelaySum.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/DelaySum.iss",inplace=1):
