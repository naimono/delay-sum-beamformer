...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=DelaySum Demo Installer\n"
      else:
        line="OutputBaseFilename=DelaySum Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the DelaySum Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the DelaySum installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=DelaySum Demo installer\n"
     else:
       line="SetupWindowTitle=DelaySum installer\n"
